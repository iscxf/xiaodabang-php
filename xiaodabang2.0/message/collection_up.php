...
<body style="background-color: #f6f6f6;">
	<div class="container" style="margin-top: 5em">
		<ul class="nav nav-tabs">
			...
			<li class="nav-item">
				<a class="nav-link active" href="collection_up.php">收藏更新</a>
			</li>
		</ul>
	</div>
	<div class="container">
	...
	<div class="container" style="margin-top: 2em">                
		<ul class="pagination justify-content-center">
				...
				echo'<li class="page-item"><a class="page-link" href="collection_up.php?page='.($page-1).'">上一页</a></li>';
				for($j=1;$j<=$total_pages;$j++)   //产生导航页码
				{
					if($j==$page)
						echo '<li class="page-item active"><a class="page-link" href="#">'.$j.'</a></li>';
					else
						echo '<li class="page-item"><a class="page-link" href="collection_up.php?page='.$j.'">'.$j.'</a></li>';
				}
				if($page<$total_pages)		//产生导航翻页
				echo '<li class="page-item"><a class="page-link" href="collection_up.php?page='.($page+1).'">下一页</a></li>';
				?>
			</ul>
		</div>
		<?php
